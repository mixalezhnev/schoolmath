...
export default class Article extends Component {
  ...
  render() {
    ...
    return (
    <div className = 'section subject' > <div className='subject__group'>
      <div className='subject__icon'></div>
      <a href='' className='subject__title'>{title}</a>
    </div> < div className = 'subject__container' > <p className='subject__desc'>{description}</p> < div className = 'subject__lessons' > {
