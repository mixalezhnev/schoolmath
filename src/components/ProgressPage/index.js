    ...
    <div className={styles.container}>
      ...
      <div className={styles.statsBlock}>
        ...
        <div className={styles.stats}>
          {data.map(subject => <div className={styles.subjectBlock} key={subject.id}>
            <div>
              <span className={styles.subjectTitle}>{subject.title}</span>
            </div>
            <div className={styles.statusContainer}>
              {subject.lessons.map(lesson => <div className={subjects[subject.id] && subjects[subject.id][lesson.id] && subjects[subject.id][lesson.id].completed
